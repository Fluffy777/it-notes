...
<body>
    ...
    <div class="container">
        <div class="profile row">
            ...
            <div class="col-auto">
                <form:form modelAttribute="userDataForm" action="${pageContext.request.contextPath}/update-profile" method="post">
                    <div class="row mb-3">
                        <div class="col">
                    ...
                    <div class="mb-3">
                        ...
                        <form:input path="bday" class="form-control" type="text" name="bday" id="input-bday" value='<%=new SimpleDateFormat("dd/MM/yyyy").format(userData.getBday())%>' placeholder="dd/mm/yyyy"/>
                    </div>
